---
title: AI-Ready Data·Knowledge 경영효과 측정
description: 데이터와 지식 준비 투자를 업무 성과와 재무 효과로 연결하고 기준선·대조군·ROI로 검증하는 방법
status: reviewed
page_type: guide
...
# AI-Ready Data·Knowledge 경영효과 측정
...
| 준비축 | 원천 문제 | 준비도 지표 | 업무 지표 | 경영 지표 |
| --- | --- | --- | --- | --- |
| Data | 표·스캔 추출 실패 | 필드 정확도·변환 성공률 | 수기 보정시간 | 외주·처리 비용 |
| Data | ACL이 색인에 미반영 | 권한 테스트 통과율 | 누출·차단 건수 | 기대손실·감사 위험 |
| Data | 변경·삭제가 늦게 전파 | 전파 SLO 충족률 | 낡은 정보 사용률 | 재작업·감사 위험 |
| Knowledge | 최종본을 모름 | 승인 SSoT 비율 | 잘못된 버전 사용률 | 재작업 비용 |
| Knowledge | 용어·단위 의미 불일치 | 표준 의미 매핑률 | 오류·반려율 | 재처리·지연 비용 |
| Knowledge | 결정·규칙의 근거 없음 | 승인 지식·인용 비율 | 확인·에스컬레이션 시간 | 처리량·준수 수준 |
| AI 운영 | 근거 없는 RAG 답변 | 인용 적합성·거절률 | 최초 해결률 | 처리량·서비스 수준 |
...
<a class="md-button md-button--primary" href="../downloads/business-impact.csv">경영효과 측정 CSV 내려받기</a>
