...
| 준비축 | 표준으로 확인할 결정 | 먼저 볼 근거 |
| --- | --- | --- |
| Data Ready | 품질 특성·측정·메타데이터·계보 | ISO/IEC 5259·25012, DCMI, PROV-O |
| Knowledge Ready | 표준 용어·동의어·분류·출처·승인 책임 | SKOS, DCMI, PROV-O, NIST AI RMF |
| 공통 운영 | 소유권·위험·성숙도·지속 개선 | NIST AI RMF, ISO/IEC 42001, DCAM |

표준이 업무상 SSoT나 효력을 대신 결정하지 않는다. Knowledge Ready의 승인 규칙은
조직의 업무 소유자와 기록관리·법무 정책이 정한다.
