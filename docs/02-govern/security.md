...
<figure class="guide-illustration">
  <img :src="'/AI-Ready-Data/images/illustrations/on-prem-security.webp'" width="1200" height="676" loading="lazy" decoding="async" alt="보안 경계 안의 사내 서버·문서 저장소·검색·AI 모델과 단계별 접근통제, 검역, 삭제 처리가 외부 네트워크와 차단된 개념 삽화">
  <figcaption>온프레미스는 설치 위치만이 아니라 원천부터 검색·모델·로그까지 이어지는 신뢰경계와 통제의 설계다.</figcaption>
</figure>
